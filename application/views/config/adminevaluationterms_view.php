        ...
        <div class="business">
            ...
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs" role="tablist">
                    <li role="presentation" >  <?php echo anchor('/settings/terms', 'Políticas de Operación', 'class="link-class"') ?></li>
                    <li role="presentation" class="active"> <?php echo anchor('/settings/evaluation_terms', 'Políticas de Evaluación', 'class="link-class"') ?></li>
                </ul>
