...
<br/>
    ...
    <div class="row">
        <div class="col-md-8">
            <h3><?php echo $contact_msgTitle ?></h3>
            <form id="frmContact" id="contactForm" novalidate>
                <div class="control-group form-group">
                    <div class="controls">
                        <label><?php echo $contact_name?></label>
                ...
                <div class="control-group form-group">
                    <div class="controls">
                        <label><?php echo $contact_phone?></label>
                ...
                <div class="control-group form-group">
                    <div class="controls">
                        <label><?php echo $contact_msg?></label>
                ...
                <button type="submit" class="btn btn-warning"><?php echo $contact_sendMsg ?></button>
            </form>
        </div>
    </div>
    <!-- /.row -->
